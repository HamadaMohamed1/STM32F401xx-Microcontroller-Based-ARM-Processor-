...
typedef struct{
	...
	uint32_t PLL_Source_MUX;			/*@ref RCC_PLL_SRC*/
	uint32_t PLLMClkDivider;			/*@ref RCC_PLLCFGR_PLLM*/
	uint32_t PLLPClkDivider;			/*@ref RCC_PLLCFGR_PLLP*/
	uint32_t PLLNMultiplicationFactor;	/*@ref RCC_PLLCFGR_PLLN*/
}RCC_OscInitTypedef;
